export default {
    ...
    'tool.parseLines.bookmarkText': 'Bookmark',
    'tool.parseLines.noteType': /Note/,
    'tool.parseLines.noteText': 'Note',
    ...
    "page.HomePage.emptyTip":'Please select your My_Clippings.txt file first !'
}
